...
export const getHeaderIcon = (column?: TableColumn) => {
  const cells: any = {
    ...
    [TableCellComponents.EditAction]: IconsEnum.Car,
    [TableCellComponents.DeleteAction]: IconsEnum.Car,
    [TableCellComponents.EmailAction]: IconsEnum.Car,
    [TableCellComponents.CallAction]: IconsEnum.Car,
